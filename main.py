...
# --- FUNÇÕES DO BOT (Idênticas às anteriores) ---
...
def processar_gasto(message):
    try:
        # ... (todo o código de processar a mensagem continua o mesmo)
...
def get_message():
    ...
    # A função abaixo foi alterada para chamar a nossa função de processamento
...
@server.route("/")
def health_check():
    # Apenas retorna uma mensagem de sucesso para o Render saber que o app está vivo
